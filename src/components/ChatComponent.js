          ...
          {messages.map((message) => (
            ...
            >
              <div className="max-w-[70%]">
                <div
                  className={`px-4 py-2 rounded-2xl ${message.sender === 'self'
            ...
            <div className="absolute right-3 flex items-center space-x-2">
              ...
              >
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M9 22H15C20 22 22 20 22 15V9C22 4 20 2 15 2H9C4 2 2 4 2 9V15C2 20 4 22 9 22Z" stroke="#6D6D6D" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                  <path d="M9 10C10.1046 10 11 9.10457 11 8C11 6.89543 10.1046 6 9 6C7.89543 6 7 6.89543 7 8C7 9.10457 7.89543 10 9 10Z" stroke="#6D6D6D" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                  <path d="M2.67004 18.9501L7.60004 15.6401C8.39004 15.1101 9.53004 15.1701 10.24 15.7801L10.57 16.0701C11.35 16.7401 12.61 16.7401 13.39 16.0701L17.55 12.5001C18.33 11.8301 19.59 11.8301 20.37 12.5001L22 13.9001" stroke="#6D6D6D" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </button>
              <button
                type="button"
      ...
      <div className="font-urbanist">
        ...
        <div className="p-4 bg-green-50">
          <div className="flex flex-col items-center">
            ...
            <h3 className="text-xl font-bold">{studentProfile.name || "Student"}</h3>
            <div className="flex items-center mt-1">
              <svg className="w-5 h-5 mr-1" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M12 21C16.9706 21 21 16.9706 21 12C21 7.02944 16.9706 3 12 3C7.02944 3 3 7.02944 3 12C3 16.9706 7.02944 21 12 21Z" stroke="black" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M13.75 12C13.75 12.97 12.97 13.75 12 13.75C11.03 13.75 10.25 12.97 10.25 12V7C10.25 6.59 10.59 6.25 11 6.25H12C12.97 6.25 13.75 7.03 13.75 8V12Z" stroke="black" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M10.25 4V2.75" stroke="black" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M13.75 4V2.75" stroke="black" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M10.25 12V17" stroke="black" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M13.75 12V17" stroke="black" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
              <span className="text-sm">From: {studentProfile.country || "Not specified"}</span>
            </div>
            <div className="grid grid-cols-2 gap-16 mt-4 w-full">
              <div className="flex items-center">
                <svg className="w-5 h-5 mr-1" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M22 10V9C22 4 20 2 15 2H9C4 2 2 4 2 9V15C2 20 4 22 9 22H11" stroke="black" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                  <path d="M15.5 18.5C16.6 18.5 17.5 17.6 17.5 16.5C17.5 15.4 16.6 14.5 15.5 14.5C14.4 14.5 13.5 15.4 13.5 16.5C13.5 17.6 14.4 18.5 15.5 18.5Z" stroke="black" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                  <path d="M20.5 21.5C21.6 21.5 22.5 20.6 22.5 19.5C22.5 18.4 21.6 17.5 20.5 17.5C19.4 17.5 18.5 18.4 18.5 19.5C18.5 20.6 19.4 21.5 20.5 21.5Z" stroke="black" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                  <path d="M22.5 16.5L18.5 14.5" stroke="black" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                  <path d="M13.5 18.5L17.5 20.5" stroke="black" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
                <span className="text-sm">Native: {studentProfile.nativeLanguage || "Not specified"}</span>
              </div>
              <div className="flex items-center">
                <svg className="w-5 h-5 mr-1" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M12.37 2.15009L21.37 5.75006C21.72 5.89006 22 6.31006 22 6.68006V10.0001" stroke="black" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                  <path d="M12.37 2.15009L3.37 5.75006C3.02 5.89006 2.75 6.31006 2.75 6.68006V16.2501C2.75 16.7401 3.13 17.2801 3.57 17.4701L11.57 21.1001C11.84 21.2201 12.3 21.2201 12.57 21.1001L20.57 17.4701C21.01 17.2801 21.39 16.7401 21.39 16.2501" stroke="black" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                  <path d="M8.93 10.8301L15.53 7.48009" stroke="black" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                  <path d="M8.93 14.1801L15.53 10.8301" stroke="black" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                  <path d="M8.93 17.5298L15.53 14.1798" stroke="black" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
                <span className="text-sm">Learning: {studentProfile.learningLanguage || "Not specified"}</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="p-4">
          <h3 className="text-lg font-semibold mb-3">Your classes booked by this student</h3>
          
          {studentProfile.classes && studentProfile.classes.length > 0 ? (
            <div className="space-y-3">
              {studentProfile.classes.map((classItem, index) => (
                <div key={index} className="border border-green-300 rounded-lg p-3 bg-[#f8fff9]">
                  {/* Class details here */}
                </div>
              ))}
            </div>
                  ...
                  filteredResources.map((resource) => (
                    <div
                      ...
                      className={`p-3 rounded-lg border cursor-pointer ${
                        selectedResources.some(res => res.docId === resource.docId)
                    ...
                    >
                      <div className="flex items-center">
                        ...
                        <div className="flex-1">
                          <h4 className="font-medium">{resource.documentName}</h4>
